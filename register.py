...
#
#         self.bg=ImageTk.PhotoImage(file=r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bgReg.jpg")
#
...
class Register:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(
            file=r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bgReg.jpg")
        ...
        # Security Question
        ssq = Label(frame, text="Select Security Question:", font=("times new roman", 15, "bold"), fg="#002B53",
                    bg="#F2F2F2")
        ssq.place(x=100, y=350)
        ...
        # Register Button
        registerbtn = Button(frame, command=self.reg, text="Register", font=("times new roman", 15, "bold"), bd=0,
                             relief=RIDGE, fg="#fff", bg="#002B53", activeforeground="white",
                             activebackground="#007ACC")
        registerbtn.place(x=103, y=510, width=270, height=35)

        # Login Button (Đã thêm command)
        loginbtn = Button(frame, command=self.go_to_login, text="Login", font=("times new roman", 15, "bold"),
                          bd=0, relief=RIDGE, fg="#fff", bg="#002B53",

...
# Student Panel: mở giao diện quản lý sinh viên.
#
# Face Detector: phát hiện khuôn mặt.
#
# Attendance: điểm danh từ nhận diện khuôn mặt.
#
# Help Support: hướng dẫn người dùng.
#
# Data Train: huấn luyện dữ liệu khuôn mặt (đào tạo mô hình).
#
# QR-Codes: mở thư mục chứa ảnh dữ liệu.
#
# Developers: thông tin lập trình viên.
#
# Exit: thoát ứng dụng.
...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        # Đường dẫn mới cho hình ảnh
        img_path = r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\banner.jpg"
        bg_path = r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bg3.jpg"
        std_img_path = r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\std1.jpg"
        det_img_path = r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\det1.jpg"
        att_img_path = r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\att.jpg"
        hlp_img_path = r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\hlp.jpg"
        tra_img_path = r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\tra1.jpg"
        pho_img_path = r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\qr1.png"
        dev_img_path = r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\dev.jpg"
        exi_img_path = r"C:\Users\LENOVO\PycharmProjects\Python-FYP-Face-Recognition-Attendence-System-master\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\exi.jpg"
        ...
        # Tạo các nút
        std_img_btn = Image.open(std_img_path)
        ...
        det_img_btn = Image.open(det_img_path)
        ...
        att_img_btn = Image.open(att_img_path)
        ...
        hlp_img_btn = Image.open(hlp_img_path)
        ...
        tra_img_btn = Image.open(tra_img_path)
        ...
        pho_img_btn = Image.open(pho_img_path)
        ...
        dev_img_btn = Image.open(dev_img_path)
        ...
        exi_img_btn = Image.open(exi_img_path)

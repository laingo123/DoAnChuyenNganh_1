...
conn = mysql.connector.connect(
    ...
    password="123456",          # Để trống nếu bạn chưa đặt password
...
class Student:
    ...
    # Phần hình ảnh bắt đầu từ đây
        ...
        #Mã sinh viên
        studentId_label = Label(class_Student_frame,text="Std-ID:(maSV)",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Tên sinh viên
        student_name_label = Label(class_Student_frame,text="Std-Name(Tên):",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Số báo danh
        student_roll_label = Label(class_Student_frame,text="Roll-No:(sốBD)",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Date of Birth
        student_dob_label = Label(class_Student_frame,text="DOB(ngSinh):",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Phone Number
        student_mob_label = Label(class_Student_frame,text="Mob-No(sốDT):",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="Tutor Name(GV):",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Hệ thống tìm kiếm trong khung bên phải
...
# ==================Khai báo các hàm==============================
    ...
    # ===========================Lấy dữ liệu từ database vào bảng ================================
    ...
    #================================get cursor function(Hàm lấy con trỏ)=======================
...
#=====================Phần này liên quan đến phần Camera của OpenCV=======================
# ===============================Tạo tập dữ liệu - chụp ảnh========================
